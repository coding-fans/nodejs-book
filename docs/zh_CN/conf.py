...
html_theme_options = {
    ...
    # GitHub
    'github_user': 'SunnySnail',
    'github_repo': 'nodejs-book',
    'github_banner': True,
    'github_type': 'star',
...
htmlhelp_basename = 'NodeJsBookdoc'
...
latex_documents = [
    (master_doc, 'NodeJs.tex', u'NodeJs小册 Documentation',
     author, 'manual'),
]
...
man_pages = [
    (master_doc, 'nodejs', u'NodeJs小册 Documentation',
     [author], 1)
]
